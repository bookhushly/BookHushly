...
export default function BookingStatusPage() {
  ...
  if (!booking) {
    return (
      <div className="flex flex-col justify-center items-center min-h-screen bg-white text-center px-4">
        ...
        <h1 className="text-2xl font-medium text-red-500">Ticket Not Found</h1>
  ...
  if (booking.status === "confirmed") {
    return (
      <div className="flex flex-col justify-center items-center min-h-screen bg-white text-center px-4">
        ...
        <h1 className="text-3xl font-medium text-purple-700">Ticket is Valid!</h1>
        <p className="text-gray-600 mt-2 max-w-md">
          Welcome! Your booking for{" "}
          <span className="font-medium">{booking.booking_date}</span> at{" "}
          <span className="font-medium">{booking.booking_time}</span> is
          confirmed.
        </p>
        <div className="mt-6 p-4 border-2 border-purple-600 rounded-lg bg-purple-50 shadow-lg">
          <p className="font-medium text-purple-700">Booking ID:</p>
  ...
  if (booking.status === "pending") {
    return (
      <div className="flex flex-col justify-center items-center min-h-screen bg-white text-center px-4">
        ...
        <h1 className="text-2xl font-medium text-yellow-600">
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-white text-center px-4">
      <XCircle className="w-20 h-20 text-red-500 mb-4" />
      <h1 className="text-2xl font-medium text-red-500">Ticket Invalid</h1>
      <p className="text-gray-600 mt-2 max-w-md">
