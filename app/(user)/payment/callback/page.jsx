...
function RedirectingScreen({ onMount }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">Your payment has been confirmed. Taking you to your order confirmation...</p>
...
export default function PaymentCallbackPage() {
  ...
  if (status === "success") {
    ...
    // Fallback: auto-redirect — no button to avoid confusion
    return <RedirectingScreen onMount={handleContinue} />;
  }
