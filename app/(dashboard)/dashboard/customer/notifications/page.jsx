...
const TYPE_CONFIG = {
  ...
  new_security_request:  { icon: Shield,    colour: "text-red-500",    bg: "bg-red-100"    },
...
const BOOKING_TYPES = ["booking_confirmed","booking_cancelled","booking_pending","booking_updated"];
const PAYMENT_TYPES = ["payment_successful","payment_failed","wallet_deposit","wallet_withdrawal"];
          ...
          {filtered.map((n) => {
            ...
            return (
              ...
              >
                {/* Unread pip */}
                {isNew && (
                  <span className="absolute top-5 -left-0 h-2 w-2 rounded-full bg-violet-500 -translate-x-[5px]" />
                )}
