export const AMENITY_OPTIONS = {
  ...
  events: [
    ...
    { value: "parking", label: "Parking Available", icon: "parking" },
    { value: "ac", label: "Air Conditioning", icon: "ac" },
    { value: "power_backup", label: "24h Power / Generator", icon: "power_backup" },
    { value: "inverter", label: "Inverter Backup", icon: "inverter" },
    { value: "security", label: "Security Services", icon: "security" },
    { value: "decoration", label: "Event Decoration", icon: "decoration" },
    { value: "changing_room", label: "Changing Room", icon: "changing_room" },
    { value: "bridal_suite", label: "Bridal Suite", icon: "bridal_suite" },
  ],
    ...
    fields: (eventType) =>
      eventType === "event_center"
        ? [
...

            {
              ...
              options: [
                ...
                { value: "dinner", label: "Dinner/Banquet" },
                { value: "parties", label: "Parties & Celebrations" },
                ...
                { value: "religion", label: "Religious Programme" },
                { value: "team_building", label: "Team Building" },
                { value: "wedding", label: "Wedding" },
              ],
            },
            {
              name: "generator_policy",
              label: "Power / Generator",
              type: "select",
              required: false,
              options: [
                { value: "24h", label: "24-Hour Power" },
                { value: "generator_included", label: "Generator Included" },
                { value: "generator_extra", label: "Generator at Extra Cost" },
                { value: "phcn_only", label: "PHCN / Grid Only" },
              ],
            },
            {
              name: "vendor_stalls",
              label: "External Vendor/Caterer Stalls",
              type: "select",
              required: false,
              options: [
                { value: "not_allowed", label: "Not Allowed" },
                { value: "allowed_free", label: "Allowed (Free)" },
                { value: "allowed_paid", label: "Allowed (Paid per Stall)" },
              ],
            },
            {
              name: "asoebi_available",
              label: "Aso-ebi Fabric Available?",
              type: "select",
              required: false,
              options: [
                { value: "no", label: "No" },
                { value: "yes", label: "Yes — Contact Venue for Details" },
              ],
            },
            {
              name: "operating_hours",
        ...
        : [
            ...
            {
              name: "asoebi_available",
              label: "Aso-ebi Available?",
              type: "select",
              required: false,
              options: [
                { value: "no", label: "No" },
                { value: "yes", label: "Yes — Contact Organizer" },
              ],
            },
          ],
  },
