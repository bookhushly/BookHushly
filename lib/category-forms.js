...
export const prepareCategoryData = (formData, category, eventType = "") => {
  const baseData = {
  ...
  switch (category) {
    case "hotels":
      categoryData.price_unit = "per_night";
      break;
    case "food":
      categoryData.price_unit = "per_person";
      break;
    case "events":
      categoryData.price_unit =
        eventType === "event_center" ? "per_event" : "per_person";
      categoryData.event_type = eventType || null;
      if (eventType === "event_organizer") {
        categoryData.remaining_tickets = parseInt(formData.total_tickets) || 0;
      }
      break;
    case "logistics":
  ...
  categoryConfig.fields.forEach((field) => {
    ...
    switch (field.name) {
      ...
      case "equipment":
        ...
        break;
      case "bedrooms":
        categoryData.bedrooms = parseInt(value);
        break;
      case "bathrooms":
        categoryData.bathrooms = parseInt(value);
        break;
      case "minimum_stay":
        categoryData.minimum_stay = value;
        break;
      case "security_deposit":
        categoryData.security_deposit = parseFloat(value);
        break;
      default:
