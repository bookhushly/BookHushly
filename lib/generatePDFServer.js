/**
 * lib/generatePDFServer.js
 *
 * Server-side ticket generation — delegates to the shared ticketGenerator.
 ...
 * The order matches computeSeatAssignments() in the booking routes so that
 ...
 * @param {number}      ticketNumber   1-indexed position within this booking (unused internally, kept for compat)
...
export async function generateAllTicketPDFsServer(
  ...
  try {
    ...
    console.error("[generateAllTicketPDFsServer] Error parsing ticket_details:", err);
