...
export const createListing = async (listingData) => {
  try {
    ...
    const processOperatingHours = (hoursData) => {
      ...
      // Get general opening/closing times
    ...
    // Process amenities - ensure they're properly structured
    ...
    const { data, error } = await supabase
      .from("listings")
      .insert({
        // Core required fields that should exist in your schema
        vendor_id: vendor.id,
        ...
        // Operating hours in multiple formats
        ...
        // Category-specific data in JSONB (this should exist)
        category_data: {
          ...
          // Events
          event_date: listingData.event_date || null,
          event_time: listingData.event_time || null,
          event_types: listingData.event_types || null,
          total_tickets: parseInt(listingData.total_tickets) || null,
        ...
        // Events specific fields (if these columns exist)
        ...
        // Status fields (these should exist)
