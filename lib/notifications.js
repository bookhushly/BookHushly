...
// Customer: booking updated (dates changed, etc.)
export async function notifyBookingUpdated(userId, { bookingId, message }) {
  return notify(userId, {
    type:    NOTIFICATION_TYPES.BOOKING_UPDATED,
    title:   "Booking Updated",
    message: message || "Your booking details have been updated.",
    data:    { bookingId },
    link:    `/dashboard/customer`,
  });
}
