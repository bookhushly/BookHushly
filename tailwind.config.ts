...
const config: Config = {
  ...
  theme: {
    // Container configuration with proper padding
    container: {
      center: true,
      padding: {
        ...
        "2xl": "2.5rem", // 40px on 2xl screens
      },
      screens: {
        sm: "640px",
        md: "768px",
    ...
    extend: {
      // Custom hospitality color palette
      colors: {
        // Brand colors matching purple logo
        brand: {
          50: "#f4f1ff",
          100: "#ebe5ff",
          200: "#d9ceff",
      ...
      // Enhanced spacing for hospitality layouts
      spacing: {
        "18": "4.5rem",
        "88": "22rem",
        "128": "32rem",
      ...
      // Hospitality-focused animations
      keyframes: {
        "fade-in": {
      ...
      // Custom border radius for hospitality feel
      borderRadius: {
        lg: "var(--radius)",
      ...
      // Screen sizes for hospitality layouts
      screens: {
        xs: "475px",
        "3xl": "1920px",
      },
